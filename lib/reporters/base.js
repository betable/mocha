...
exports.list = function(failures){
  ...
  failures.forEach(function(test, i){
    ...
    if ('string' == typeof actual && 'string' == typeof expected) {
      ...
      if (err.description) {
        msg = color('error message', err.description) + '\n' + msg
      }
...
function Base(runner) {
  ...
  runner.on('end', function(terminated) {
...
Base.prototype.epilogue = function(){
  ...
  console.log();
    ...
    if (this.stats.terminated) {
        console.log()
        console.log(color('bright fail', 'Runner was terminated early, not all tests were executed'))
        console.log()
    }
