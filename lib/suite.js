...
Suite.prototype.beforeAll = function (fn) {
    ...
    hook.slow(this.slow())
    hook.pending = hook.pending || this.pending
...
Suite.prototype.allTests = function () {
    ...
    function init_each (test, each) {
        ...
        new_each.title = each.fullTitle('/') + ' - ' + test.title
        new_each.pending = new_each.pending || test.pending
...
Suite.prototype.addSuite = function (suite) {
    suite.timeout(this.timeout())
    suite.slow(this.slow())
    suite.pending = suite.pending || this.pending
...
Suite.prototype.addTest = function (test) {
    ...
    test.slow(this.slow())
    test.pending = test.pending || this.pending
