...
Runner.prototype.run = function(fn) {
    ...
    self.on('end', function () {
        //TODO: Pretty sure this never hits
        debug('end')
        fn(self.failures)
    })
    ...
    do {
        ...
        while (suite_queue.length > 0) {
            ...
            if (sub_suite.exclusive()) {
                //TODO: This needs to be handled in the new way like below
                exclusives.push(sub_suite)
            } else {
                suite_level.push(sub_suite.allTests())
        ...
        self._walk_tests(root_node, suite_level)
