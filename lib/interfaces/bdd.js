...
module.exports = function (suite) {
    ...
    suite.on('pre-require', function (context, file, mocha) {
        ...
        context.before = function(fn){
            ...
            return suites[0]._beforeAll.slice(-1)[0] || new Hook()
        }
        ...
        context.after = function(fn){
            ...
            return suites[0]._afterAll.slice(-1)[0] || new Hook()
        }
        ...
        context.beforeEach = function(fn){
            ...
            return suites[0]._beforeEach.slice(-1)[0] || new Hook()
        }
        ...
        context.afterEach = function (fn) {
            ...
            return suites[0]._afterEach.slice(-1)[0] || new Hook()
        }
         ...
         * No tests will be run in a pending suite
         *
         * @param {String} title The suites title
         * @param {function} fn Function to execute to build nested suites or tests
         *
